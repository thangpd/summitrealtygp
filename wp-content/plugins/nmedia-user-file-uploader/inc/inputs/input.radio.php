...
class NM_Radio extends WPFM_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Radio Input', 'nm-filemanager' );
		$this -> desc		= __ ( 'regular radio input', 'nm-filemanager' );
	...
	private function get_settings(){
		...
		'selected' => array (
				...
				'desc' => __ ( 'Type option name (given above) if you want already radioed.', 'nm-filemanager' ) 
		),
