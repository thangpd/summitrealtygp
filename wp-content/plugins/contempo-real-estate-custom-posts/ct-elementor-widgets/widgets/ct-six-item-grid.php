 ...
 * @since 1.0.0
 */
class CT_Six_Item_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'CT 6 Item Grid', 'contempo' );
	}
	...
	protected function render() {
		...
		echo '<ul class="item-grid grid-six-item">';
			...
			echo '<div class="col span_4 first">';
				echo '<li class="grid-item col span_12 first" style="background-image: url(' . $settings['image_four']['url'] . '); background-size: cover;">';
					...
					echo '</a>';
				echo '</li>';
				echo '<li class="grid-item col span_12 first" style="background-image: url(' . $settings['image_five']['url'] . '); background-size: cover;">';
			...
			echo '<div class="col span_8">';
				echo '<li class="grid-item col span_12 first" style="background-image: url(' . $settings['image_six']['url'] . '); background-size: cover;">';
