 ...
 * @since 1.0.0
 */
class CT_Modern_Four_Item_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'ct-modern-four-item-grid';
	}
	...
	public function get_title() {
		return __( 'CT Modern 4 Item Grid', 'contempo' );
	}
	...
	protected function render() {
		...
		echo '<ul class="item-grid modern-item-grid">';
			...
			echo '<li class="grid-item col span_6" style="background-image: url(' . $settings['image_one']['url'] . '); background-size: cover;">';
					echo '<a href="' . $settings['link_one']['url'] . '"' . $target_one . $nofollow_one . '>';
				} else {
					echo '<li class="grid-item col span_6 no-link" style="background-image: url(' . $settings['image_one']['url'] . '); background-size: cover;">';
				}
					//echo '<figure>';
			...
			echo '<li class="grid-item col span_6" style="background-image: url(' . $settings['image_two']['url'] . '); background-size: cover;">';
					echo '<a href="' . $settings['link_two']['url'] . '"' . $target_two . $nofollow_two . '>';
				} else {
					echo '<li class="grid-item col span_6 no-link" style="background-image: url(' . $settings['image_two']['url'] . '); background-size: cover;">';
				}
					//echo '<figure>';
			...
			echo '<li class="grid-item col span_6" style="background-image: url(' . $settings['image_three']['url'] . '); background-size: cover;">';
					echo '<a href="' . $settings['link_three']['url'] . '"' . $target_three . $nofollow_three . '>';
				} else {
					echo '<li class="grid-item col span_6 no-link" style="background-image: url(' . $settings['image_three']['url'] . '); background-size: cover;">';
				}
					//echo '<figure>';
			...
			echo '<li class="grid-item col span_6" style="background-image: url(' . $settings['image_four']['url'] . '); background-size: cover;">';
					echo '<a href="' . $settings['link_four']['url'] . '"' . $target_four . $nofollow_four. '>';
				} else {
					echo '<li class="grid-item col span_6 no-link" style="background-image: url(' . $settings['image_four']['url'] . '); background-size: cover;">';
				}
					//echo '<figure>';
