...
if ( ! function_exists( 'ct_Listings' ) ) {
	class ct_Listings extends WP_Widget {
		...
		function widget( $args, $instance ) {
                ...
                <li class="listing <?php echo esc_html( $ct_search_results_listing_style ); ?>">
                    ...
                    <div class="grid-listing-info">
                        <header>
							...
							?>
                            <p class="location marB0"><?php echo esc_html( $city ); ?>
                                , <?php echo esc_html( $state ); ?> <?php echo esc_html( $zipcode ); ?> <?php echo esc_html( $country ); ?></p>
                        </header>
			...
			<?php if ( $viewalltext ) { ?>
                <p id="viewall"><a class="read-more right"
                                   href="<?php echo esc_url( $viewalllink ); ?>"><?php echo esc_html( $viewalltext ); ?>
                        <em>&rarr;</em></a></p>
			<?php } ?>
		...
		function form( $instance ) {
            ...
            <p>
                ...
                <select name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" class="widefat"
                        id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
					<?php for ( $i = 1; $i <= 10; $i += 1 ) { ?>
                        <option value="<?php echo esc_attr( $i ); ?>" <?php if ( $number == $i ) {
            ...
            <p>
                ...
                <select name="<?php echo esc_attr( $this->get_field_name( 'taxonomy' ) ); ?>" class="widefat"
					...
					foreach ( get_object_taxonomies( 'listings', 'objects' ) as $tax => $value ) { ?>
                        <option value="<?php echo esc_attr( $tax ); ?>" <?php if ( $taxonomy == $tax ) {
							echo "selected='selected'";
						} ?>><?php echo esc_html( $tax ); ?></option>
					<?php } ?>
                </select>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'tag' ) ); ?>"><?php esc_html_e( 'Tag:', 'contempo' ); ?></label>
                <input type="text" name="<?php echo esc_attr( $this->get_field_name( 'tag' ) ); ?>"
                       value="<?php echo esc_attr( $tag ); ?>" class="widefat"
            ...
            <p>
                ...
                <input type="text" name="<?php echo esc_attr( $this->get_field_name( 'viewalltext' ) ); ?>"
                       value="<?php echo esc_attr( $viewalltext ); ?>" class="widefat"
                       id="<?php echo esc_attr( $this->get_field_id( 'viewalltext' ) ); ?>"/>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'viewalllink' ) ); ?>"><?php esc_html_e( 'View All Link URL', 'contempo' ); ?></label>
                <input type="text" name="<?php echo esc_attr( $this->get_field_name( 'viewalllink' ) ); ?>"
                       value="<?php echo esc_attr( $viewalllink ); ?>" class="widefat"
                       id="<?php echo esc_attr( $this->get_field_id( 'viewalllink' ) ); ?>"/>
            </p>
			<?php
		}
	}
